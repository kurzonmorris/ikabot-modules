...
|--------|------|--------------|
| Resource Transport Manager | `modules/resourceTransportManager_v10.13.0.py` | Resource movement, ship routing, notifications. Priority scheduling (1–5), trading-port hold list, shipment history with resend, cycle deadlines, supervised background worker, per-account logs |
