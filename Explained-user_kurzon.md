...
|--------|------|--------------|
| Resource Transport Manager | `modules/resourceTransportManager_v10.10.0.py` | Resource movement, ship routing, notifications. Priority scheduling (1–5), trading-port hold list, cycle deadlines, supervised background worker, per-account logs |
