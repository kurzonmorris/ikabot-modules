...
**[ikabot-docker_v1.0.31.zip](https://github.com/kurzonmorris/ikabot-modules/raw/main/releases/ikabot-docker_v1.0.31.zip)**
...
2. **Right-click** `ikabot-docker_v1.0.31.zip` → **Properties**
3. If you see an **Unblock** tickbox at the bottom, tick it and press **OK**
4. **Right-click** the file again → **Extract All…** → **Extract**

A folder called `ikabot-docker_v1.0.31` opens. Inside it you should see:
...
> numbered separately and are usually a little apart — installer `v1.0.31`
> carries control panel `v1.0.27`, for instance. A lower number on the page
